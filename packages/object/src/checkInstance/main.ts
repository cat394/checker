import type { InstancedClass } from "../types.ts";
 ...
 * @param {InstancedClass} constructor - The constructor function or class to check against.
 ...
 */
export const checkIsNotInstance = <
  T1 extends unknown,
  T2 extends InstancedClass,
>(
  value: T1,
  constructor: T2,
